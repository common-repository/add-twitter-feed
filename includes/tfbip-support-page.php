...
if( isset($_POST['submit']) ){
	...
	if($formok){
		...
		$emailbody = "<p>Twitter Feed Support (Free Version).</p>
		...
		mail("iconplugins@gmail.com","Twitter Feed Support (Free Version)",$emailbody,$headers);
...
#upc_contact-form {
    background-color:rgba(0, 188, 212, 0.28);
    width:465px;
    padding:20px;
    margin: 50px;   
    border: 6px solid rgba(244, 67, 54, 0.67);
...
#upc_contact-form #submit-button:hover {
    background-color: rgba(33, 150, 243, 0.57);
}
...
<div id="container">
        <div id="upc_contact-form" class="clearfix">
            ...
            <h2>You can contact us anytime, we'll do our best to answer and resolve all your questions & issues as early as possible</h2>
